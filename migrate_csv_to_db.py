...
#     rem = 0.01 if str(sleep.loc[idx, 'REM'])=='nan' else 0.01 if float(sleep.loc[idx, 'REM'])== 0.0 else float(sleep.loc[idx, 'REM'])
#     awake = 0.01 if str(sleep.loc[idx, 'awake'])=='nan' else float(sleep.loc[idx, 'awake'])
#     deep_sleep = 0.01 if str(sleep.loc[idx, 'deep sleep'])=='nan' else float(sleep.loc[idx, 'deep sleep'])
#     light_sleep = 0.01 if str(sleep.loc[idx, 'light sleep'])=='nan' else float(sleep.loc[idx, 'light sleep'])
#     try:
#         sleep_score = None if str(sleep.loc[idx, 'sleep score'])=='nan' else int(sleep.loc[idx, 'sleep score'])
#     except:
#         sleep_score = 0
...
#     # print(sleep_, rem, awake, deep_sleep, light_sleep, sleep_score, insomnia, freq_wakes, sleep_meds, tz_change, date)
